...
output="/mnt/data/dayhoff/home/projects/bird_trees/bbsb/hessian/posterior"
...
sed -i "s|usedata = 2 /in.BV|usedata = 2 $baseml/$family/rst2|" "$family_directory/mcmc_treearr.ctl"
